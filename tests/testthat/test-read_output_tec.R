d1_path <- paste0(bm_prefix,
                  "extdata/ogs5_benchmarks_ref/mcwt_domain_quad_0.tec")
d2_path <- paste0(bm_prefix,
"extdata/ogs5_benchmarks_ref/trans_bd_homo_domain_GROUNDWATER_FLOW_quad.tec")
