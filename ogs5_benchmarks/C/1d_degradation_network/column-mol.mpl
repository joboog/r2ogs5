...
rate8 := muo*baco*c3h5o3bio/(c3h5o3bio+kmoc)*o2bio/(o2bio+kmo)*bacmax/(bacmax+bactot)*(1-sw1)
rate9 := deco*baco*(1.-bacomin/baco)*(1-sw1)
rate10 := mun*baco*c3h5o3bio/(c3h5o3bio+kmnc)*no3bio/(no3bio+kmn)*kinho1/(o2+kinho1)*bacmax/(bacmax+bactot)*(1-sw1)
rate11 := decn*bacn*(1.-bacnmin/bacn)*(1-sw1)
rate12 := muc*bacc*c3h5o3bio/(c3h5o3bio+kmcc)*kinho2/(o2+kinho2)*bacmax/(bacmax+bactot)*(1-sw1)
rate13 := decc*bacc*(1.-baccmin/bacc)*(1-sw1)
rate14 := mum*bacm*c3h5o2bio/(c3h5o2bio+kmmc)*mno2bio/(mno2bio+kmm)*bacmax/(bacmax+bactot)*kinho2/(o2+kinho2)*(1-sw1)
rate15 := decm*bacm*(1.-bacmmin/bacm)*(1-sw1)
rate16 := muf*bacf*c3h5o2bio/(c3h5o2bio+kmfc)*feoohbio/(feoohbio+kmf)*bacmax/(bacmax+bactot)*kinho2/(o2+kinho2)*(1-sw1)
rate17 := decf*bacf*(1.-bacfmin/bacf) *(1-sw1)
rate18 := mus*bacs*c3h5o2bio/(c3h5o2bio+kmsc)*so4bio/(so4bio+kms)*bacmax/(bacmax+bactot)*kinho2/(o2+kinho2)*(1-sw1)
